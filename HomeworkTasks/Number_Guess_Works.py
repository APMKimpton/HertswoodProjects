...
def main():
    ...
    def program(guess,tries,score):
        if guess < computer_number:
            ...
            print("Try again!")
            return False
        elif guess > computer_number: #why does it know computer_number? - Does that mean I dont have to pass all these vars, and instead use their real var names?
            ...
            if tries < score or score == 0:
                print("Congrats you beat the last person by", abs(score-tries))
